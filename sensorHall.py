...
def intensity_field(opt):
    """Esta función retorna la intensidad campo que lee  el sensor 49e de efecto Hall

    Args:
        opt (bool): Opcion para retornar un valor (intensidad de campo) o una tupla (intensidad de campo y voltaje

    Returns:
        float|tuple[float, float]: Intensidad de campo o Intensidad de campo y voltaje
    """
